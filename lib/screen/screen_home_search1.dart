...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void _onMapCreated(MaplibreMapController controller) async {
    ...
    await _mapController!.updateContentInsets(EdgeInsets.only(bottom: _height * 0.2));
    _goToMyPosition();
  }
                              ...
                              sliver: SliverVisibility(
                                ...
                                sliver: ValueListenableConsumer<PlaceState>(
                                  ...
                                  builder: (context, state, child) {
                                    ...
                                    return SliverVisibility(
                                      visible: state is! PendingPlaceState || state is! FailurePlaceState,
                                      replacementSliver: const SliverFillRemaining(child: HomeSearchShimmer()),
                                      sliver: SliverVisibility(
