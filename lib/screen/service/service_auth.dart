...
class AuthService extends ValueNotifier<AuthState> {
  ...
  void handle(AuthEvent event) => event._execute(this);

  Future<void> handleSync(AuthEvent event) => event._execute(this);

  void onState(ValueChanged<AuthState> callBack) => callBack(value);
}
